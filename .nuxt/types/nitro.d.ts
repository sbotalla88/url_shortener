...
declare module 'nitropack' {
  ...
  interface InternalApi {
    '/api/url/short': Awaited<ReturnType<typeof import('../../server/api/url/short').default>>
    '/api/url/match': Awaited<ReturnType<typeof import('../../server/api/url/match').default>>
    '/api/url': Awaited<ReturnType<typeof import('../../server/api/url/index').default>>
